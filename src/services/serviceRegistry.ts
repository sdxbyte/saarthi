...
export const SERVICE_DEFINITIONS: ServiceDefinition[] = [
  ...
  // 14. Sajilo (सजिलो) - Nepali Daily Essentials (github.com/adarshaacharya/sajilo)
  {
    id: 'sajilo-essentials',
    number: 14,
    title: 'Sajilo (Daily Essentials Hub)',
    titleNp: 'सजिलो (दैनिक आवश्यकताहरू)',
    parentCategory: 'tools',
    subcategory: 'daily_utilities',
    description: 'All-in-one Nepali daily utilities: Kalimati vegetables & fruits wholesale, Gold & Silver bullion, Petrol & Fuel, Live Nepali FM Radio stations, offline Keeper reminders, Land Area converters, and 24/7 Emergency helplines.',
    descriptionNp: 'कालिमाटी तरकारी तथा फलफूल बजार भाउ, सुनचाँदी र इन्धन दर, प्रत्यक्ष नेपाली एफएम रेडियो, व्यक्तिगत किपर रिमाइन्डर, जग्गा क्षेत्रफल र आपतकालीन सम्पर्क।',
    iconName: 'Sparkles',
    badge: 'Sajilo',
    targetTab: 'sajilo',
    subViewId: 'sajilo-main',
    tags: ['sajilo', 'kalimati', 'vegetables', 'radio', 'fm', 'keeper', 'reminder', 'bazar', 'gold', 'fuel', 'land', 'emergency', 'tola', 'ropani', 'bigha'],
  },
];
