...
const THEME_OPTIONS: ThemeOption[] = [
  ...
  {
    id: 'pearl',
    nameEn: 'Pearl White Crisp Light',
    nameNe: 'सफा उज्यालो (लाइट थिम)',
    descEn: 'Ultra-clean off-white canvas with high contrast typography and subtle slate borders.',
    descNe: 'आँखालाई आरामदायी र स्पष्ट अक्षर भएको सफा उज्यालो क्यानभास।',
    colors: {
      bg: '#F8FAFC',
      card: '#FFFFFF',
      accent: '#2563EB',
