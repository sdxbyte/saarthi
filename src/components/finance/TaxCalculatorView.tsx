    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border border-slate-800 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block px-3 py-1.5 rounded-xl bg-red-600/20 border border-red-500/30 text-red-400 text-xs font-semibold">
            IRD Standard
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-4 shadow-md">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3.5 py-2.5 text-white font-mono text-sm focus:border-red-500 outline-none"
            />
          ...
          <div className="pt-2 border-t border-slate-800 space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-white font-mono text-xs outline-none"
              />
            </div>
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-3 shadow-md">
                ...
                <tbody className="divide-y divide-slate-800/60 text-slate-300">
                  {taxResult.slabs.map((s, idx) => (
                    <tr key={idx} className="hover:bg-slate-800/40">
                      <td className="py-2.5 font-medium text-slate-200">{s.range}</td>
                      <td className="py-2.5 font-bold text-amber-400">{s.rate}%</td>
            ...
            <div className="p-3 rounded-xl bg-slate-800/60 border border-slate-700/50 text-xs text-slate-400 flex items-start gap-2">
